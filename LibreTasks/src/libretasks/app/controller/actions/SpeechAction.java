...
public class SpeechAction extends OmniAction {
	public static final String ACTION_NAME = "Speak";
	public static final String SPEECH_INTENT = "libretasks.intent.action.SPEAK";
	public static final String PARAM_MESSAGE = "Message";

	// Content of the action
	private String message;

	public SpeechAction(HashMap<String, String> parameters) throws OmnidroidException {
		super(SpeechAction.SPEECH_INTENT, Action.BY_SERVICE);
