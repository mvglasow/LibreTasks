...
/**
 * This class encapsulates a BluetoothDisconnected event. It wraps the intent that triggered this event
 * and provides access to any attribute data associated with it.
 */
public class BluetoothDisconnectedEvent extends Event {
	/** Event name (to match record in database) */
	public static final String APPLICATION_NAME = "Bluetooth";
	public static final String EVENT_NAME = "Bluetooth Device Disconnected";
	public static final String ACTION_NAME = "BLUETOOTH_DISCONNECTED";
	...
	public BluetoothDisconnectedEvent(Intent intent) {
